                    ...
                    <div class="form-control">
                        ...
                        <select class="form-floating mb-3" name="kode_cabang" required onchange="this.form.submit()">
                            ...
                            <?php foreach ($cabang as $row) : ?>
                                <option value="<?= $row['kode_cabang']; ?>" <?= ($kode_cabang_sekarang == $row['kode_cabang']) ? 'selected' : ''; ?>>
                                    <?= $row['nama_cabang']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Data Gadai</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Data Penebusan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Data Perpanjangan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Data Denda</a>
                        </li>
                    </ul>
                                        ...
                                        <div>
                                            ...
                                            ?>
                                                <tr class="text-center <?= 'bg-' . $row->jatuh_tempo_now; ?>">
                                                    ...
                                                    <textarea name="" hidden class="datarow-<?= $row->kode_pinjaman; ?>" id=""><?= json_encode($row); ?></textarea>
                                                </tr>
                                            <?php
                                            endforeach;
                                            ?>
