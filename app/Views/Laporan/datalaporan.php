        ...
        <div class="section-header-button">
            <div class="dropdown show">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" id="akses-excel" href="<?php echo base_url('excel/export') ?>"><i class="fa fa-file-excel"></i> EXCEL</a>
                    <!-- <a class="dropdown-item" href="<?php echo base_url('excel/tes') ?>">Test Data</a> -->
                    <a class="dropdown-item" href="<?php echo base_url('/uploadForm') ?>"><i class="fa fa-upload"></i> UPLOAD DATA</a>
                </div>
            </div>
        </div>
    </div>
