    ...
    <div class="container">
        <?php if ($session->get('level') == 'superadmin') :  ?>
            <ul class="navbar-nav ">
                ...
                <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle" aria-expanded="false">Pengaturan</a>
                ...
                <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle" aria-expanded="false">Lelang</a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle" aria-expanded="false">Laporan</a>
                    <ul class="dropdown-menu">
