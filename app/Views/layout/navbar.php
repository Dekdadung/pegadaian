...
<nav class="navbar navbar-secondary navbar-expand-lg">
    <div class="container">
        ...
        <ul class="navbar-nav ">
            ...
            <li class="nav-item dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle"
                    aria-expanded="false">Histori</a>
                <ul class="dropdown-menu">
                    <li><a href="<?= site_url('laporanlunas') ?>" class="nav-link sc_load">Histori Penebusan</a></li>
                    <li><a href="<?= site_url('laporan') ?>" class="nav-link sc_load">Histori Denda</a></li>
                    <li><a href="<?= site_url('laporanakanlelang') ?>" class="nav-link sc_load">Histori Perpanjangan</a>
                    </li>
                </ul>
            </li>
        </ul>
